...
class Admin{
    ...
    public function generalFilterSettings( $settings )
    {
        ...
        /*$settings['mobile_devices']['fields']['mobile_filter_settings'] = array(
            'type'  => 'select',
            ...
            'options'       => array(
                ...
                'collapsed' => esc_html__('Collapsed and expanded', 'filter-everything'),
                'popup' => esc_html__('Appear as a Pop-up', 'filter-everything')
            ),
            'default' => 'no',
            'id'    => 'mobile_filter_setting',
            //'description' => esc_html__('', 'filter-everything'),
        );*/

        $settings['mobile_devices']['fields']['mobile_filter_settings']['options']['show_bottom_widget'] = esc_html__('Appear as a Pop-up', 'filter-everything');
