...
if (!class_exists('B2bking_New_Message_Email')){
    class B2bking_New_Message_Email extends WC_Email {
        ...
        public $userid;
        public $reply_to_email; // Add this property
        ...
        public function __construct() {
            ...
            $this->userid = '';
            $this->conversationid = '';
            $this->reply_to_email = ''; // Initialize reply-to property
        ...
        public function trigger($email_address, $message, $userid, $conversationid) {
            ...
            // Set reply-to email from POST data if available
            if (isset($_POST['email']) && is_email($_POST['email'])) {
                $this->reply_to_email = sanitize_email($_POST['email']);
            } elseif (isset($_POST['b2bking_request_custom_quote_email']) && is_email($_POST['b2bking_request_custom_quote_email'])) {
                $this->reply_to_email = sanitize_email($_POST['b2bking_request_custom_quote_email']);
            }
        ...
        // Override get_headers to add Reply-To
        public function get_headers() {
            $headers = parent::get_headers();
            
            // Add Reply-To header if we have a reply-to email
