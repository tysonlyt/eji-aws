...
if (!class_exists('B2bking_Your_Account_Approved_Email')){
    class B2bking_Your_Account_Approved_Email extends WC_Email {
        ...
        public function get_subject() {
            ...
            $domain = 'admin_texts_woocommerce_b2bking_your_account_approved_email_settings';
            $name = '[woocommerce_b2bking_your_account_approved_email_settings]subject';

            if (function_exists('icl_translate')) {
                $translated = icl_translate($domain, $name, $subject);
        ...
        public function get_heading() {
            ...
            $domain = 'admin_texts_woocommerce_b2bking_your_account_approved_email_settings';
            $name = '[woocommerce_b2bking_your_account_approved_email_settings]heading';

            if (function_exists('icl_translate')) {
                $translated = icl_translate($domain, $name, $heading);
        ...
        public function get_additional_content() {
            $additional_content = parent::get_additional_content();

            $domain = 'admin_texts_woocommerce_b2bking_your_account_approved_email_settings';
            $name = '[woocommerce_b2bking_your_account_approved_email_settings]additional_content';

            if (function_exists('icl_translate')) {
                $translated = icl_translate($domain, $name, $additional_content);
                if ($translated !== $additional_content) {
                    return $translated;
                }
            }
