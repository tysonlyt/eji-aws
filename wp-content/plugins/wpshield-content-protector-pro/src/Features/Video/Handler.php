...
namespace WPShield\Plugin\ContentProtectorPro\Features\Video;
 ...
 * @since   1.0.0
 *
 * @package WPShield\Plugin\ContentProtectorPro\Modules\Video
 */
class Handler extends Component implements Module, Installable {

	/**
	 * Store instance of video creator object.
	 *
	 * @var \WPShield\Plugin\ContentProtectorPro\Features\Video\Creator
	 */
	protected $creator;
