...
?>
<div class="<?php echo esc_attr( $container_classes ); ?> bf-fields-style bf-section-container bf-metabox" <?php echo $section_css_attr; // escaped before ?> <?php echo $section_attr; // escaped before ?>>
    <div class="<?php echo esc_attr( $section_classes ); ?>"
        ...
        <div class="<?php echo esc_attr( $heading_classes ); ?>">
                ...
                <h3>
                    <label for="<?php echo esc_attr( $options['input_name'] ); ?>"><?php echo esc_html( $options['name'] ); ?></label>
                </h3>
