...
namespace BetterFrameworkPackage\Core\Module;
 ...
 * @format  Core Module
 */
abstract class ModuleHandler implements \BetterFrameworkPackage\Core\Module\NeedSetup {
	...
	public static function setup(): bool {
		...
		if ( $instance instanceof \BetterFrameworkPackage\Core\Module\ShouldSaveData ) {

			array_map(
				[
					\BetterFrameworkPackage\Utils\Http\Handlers\SaveRequestHandler::class,
					'register'
				],
	...
	public static function template( string $template_name, bool $return = true ): string {
		...
		\BetterFrameworkPackage\Core\load_template( $template_name, static::path( '/Templates/' ) );
