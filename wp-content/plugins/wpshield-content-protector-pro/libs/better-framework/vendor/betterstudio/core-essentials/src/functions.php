...
namespace BetterFrameworkPackage\Core;
...
function render_messages( $the_error ): string {
	...
	\BetterFrameworkPackage\Core\set_template_variable( 'messages', $errors );

	ob_start();

	\BetterFrameworkPackage\Core\load_template( 'messages.php', __DIR__ . '/Templates' );
