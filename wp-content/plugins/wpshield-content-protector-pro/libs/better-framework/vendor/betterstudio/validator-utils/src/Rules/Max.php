...
class Max extends \BetterFrameworkPackage\Utils\Validator\Rules\Rule {
	...
	: string {
		...
		return sprintf(
			_x( 'Maximum length of %s is %s.', 'The %s is the field name and the second one is max allowed length.', 'betterstudio' ),
			$placeholders['label'],
