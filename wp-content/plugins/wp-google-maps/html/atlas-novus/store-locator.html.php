<div class="wpgmza-store-locator">
	...
	<svg width="40" height="40" viewBox="0 0 59 59" fill="none" xmlns="http://www.w3.org/2000/svg" class="wpgmza-search wpgmza-aria-bridge" title="<?php esc_attr_e('Search', 'wp-google-maps'); ?>" aria-label="<?php esc_attr_e('Search', 'wp-google-maps'); ?>" role="button" tabindex="0">
	...
	<svg width="40" height="40" viewBox="0 0 62 62" fill="none" xmlns="http://www.w3.org/2000/svg" class="wpgmza-reset wpgmza-aria-bridge" title="<?php esc_attr_e('Reset', 'wp-google-maps'); ?>" aria-label="<?php esc_attr_e('Reset', 'wp-google-maps'); ?>" role="button" tabindex="0">
