			...
			<div class="wt-cta-banner">
				<div class="wt-cta-content">
					...
					<ul class="wt-cta-features">
						...
						<li><?php esc_html_e( 'Supports all types of products (Simple, variable, subscription grouped, and external)', 'wt-woocommerce-related-products' ); ?></li>
						<li><?php esc_html_e( 'Multiple file formats - CSV, XML, Excel, and TSV', 'wt-woocommerce-related-products' ); ?></li>
						<li><?php esc_html_e( 'Advanced filters and customizations for better control', 'wt-woocommerce-related-products' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Bulk update WooCommerce product data', 'wt-woocommerce-related-products' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Import via FTP/SFTP and URL', 'wt-woocommerce-related-products' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Schedule automated import & export', 'wt-woocommerce-related-products' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Export and Import custom fields and third-party plugin fields', 'wt-woocommerce-related-products' ); ?></li>
					</ul>
