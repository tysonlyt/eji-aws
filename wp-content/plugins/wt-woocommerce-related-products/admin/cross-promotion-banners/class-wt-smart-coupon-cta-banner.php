			...
			<div class="wt-cta-banner">
				<div class="wt-cta-content">
					...
					<ul class="wt-cta-features">
						<li><?php esc_html_e( 'Auto-apply coupons', 'wt-woocommerce-related-products' ); ?></li>
						<li><?php esc_html_e( 'Create attractive Buy X Get Y (BOGO) offers', 'wt-woocommerce-related-products' ); ?></li>
						<li><?php esc_html_e( 'Create product quantity/subtotal based discounts', 'wt-woocommerce-related-products' ); ?></li>
						<li><?php esc_html_e( 'Offer store credits and gift cards', 'wt-woocommerce-related-products' ); ?></li>
						<li><?php esc_html_e( 'Set up smart giveaway campaigns', 'wt-woocommerce-related-products' ); ?></li>
						<li><?php esc_html_e( 'Set advanced coupon rules and conditions', 'wt-woocommerce-related-products' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Bulk generate coupons', 'wt-woocommerce-related-products' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Shipping, purchase history, and payment method-based coupons', 'wt-woocommerce-related-products' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Sign up coupons', 'wt-woocommerce-related-products' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Cart abandonment coupons', 'wt-woocommerce-related-products' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Create day-specific deals', 'wt-woocommerce-related-products' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Display coupon banners and widgets', 'wt-woocommerce-related-products' ); ?></li>
						<li class="hidden-feature"><?php esc_html_e( 'Import coupons', 'wt-woocommerce-related-products' ); ?></li>
					</ul>
