...
class EnqueueScript implements \BetterFrameworkPackage\Asset\Enqueue\EnqueueInterface {
	...
	public function add( string $handle, $src, $path = false, $deps = [], $ver = false, $args = null ): bool {
		...
		return bf_register_script( $handle, $src, $deps, $path, $ver );
	}
	...
	public function enqueue( array $handles ): bool {
		...
		array_map( 'bf_enqueue_script', $handles );
	...
	public function dequeue( array $handles ): bool {
		...
		array_map( 'bf_dequeue_script', $handles );
