...
?>
<div
		class="<?php echo esc_attr( $container_classes ); ?> bf-section-container bf-metabox" <?php echo $section_css_attr; // escaped before ?> <?php echo $section_attr; // escaped before ?>>
