...
<div <?php \BetterFrameworkPackage\Component\Control\container_attributes( $props, 'bs-color-picker-wrapper' ); ?>>
        ...
        <button type="button" class="button wp-color-result" aria-expanded="false">
            ...
            <span class="color-alpha-wrapper" style="background-image: url('data:image/png;base64,');">
                ...
                if ( ! empty( $props['value'] ) ) {
					?>
                     style="background-color: <?php echo esc_attr( $props['value'] ); ?>;"<?php } ?>></span>
            </span>
        </button>
    </div>
    ...
    <input type="text" name="<?php echo esc_attr( $props['input_name'] ?? '' ); ?>"
           ...
           class="bs-color-picker-value color-picker <?php echo esc_attr( $props['input_class'] ?? '' ); ?>" data-alpha-enabled="true"
