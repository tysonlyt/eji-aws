...
git clone git@github.secureserver.net:WPPaaS/wp-paas-system-plugin.git
...
echo ""
echo "Submit the PR:"
echo "https://github.secureserver.net/WPPaaS/wp-paas-system-plugin/compare/develop...release-expert-banner-$1"
