...
/**
 * The "estimate shipping" event.
 *
 * @since 3.0.0
 */
class Estimate_Shipping_Event extends GA4_Event {


	/** @var string the event ID */
	public const ID = 'estimate_shipping';
	...
	public function get_form_field_title(): string {
		...
		return __( 'Estimate Shipping', 'woocommerce-google-analytics-pro' );
	}
	...
	public function track(): void {
		...
		$this->record_via_api( [ 'category' => 'Cart' ] );
	}
