...
/**
 * The "viewed signup" event.
 *
 * @since 3.0.0
 */
class Viewed_Signup_Event extends Universal_Analytics_Event {


	/** @var string the event ID */
	public const ID = 'viewed_signup';
	...
	public function get_form_field_title(): string {
		...
		return __( 'Viewed Signup', 'woocommerce-google-analytics-pro' );
	}
