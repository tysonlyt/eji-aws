...
/**
 * The "applied coupon" event.
 *
 * @since 3.0.0
 */
class Applied_Coupon_Event extends Universal_Analytics_Event
{


	/** @var string the event ID */
	public const ID = 'applied_coupon';
	...
	public function get_form_field_title(): string {
		...
		return __( 'Applied Coupon', 'woocommerce-google-analytics-pro' );
	}
