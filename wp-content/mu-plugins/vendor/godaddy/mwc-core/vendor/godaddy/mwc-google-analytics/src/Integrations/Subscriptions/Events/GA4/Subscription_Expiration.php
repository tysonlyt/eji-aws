...
/**
 * The "subscription expiration" event.
 *
 * @since 3.0.0
 */
class Subscription_Expiration extends GA4_Event implements Subscription_Event {

	use Tracks_Subscription_Events;


	/** @var string the event ID */
	public const ID = 'subscription_expiration';
	...
	public function get_form_field_title(): string {
		...
		return __( 'Subscription Expiration', 'woocommerce-google-analytics-pro' );
	}
