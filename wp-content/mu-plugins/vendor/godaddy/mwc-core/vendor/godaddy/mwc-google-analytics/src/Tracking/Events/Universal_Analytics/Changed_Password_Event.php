...
/**
 * The "changed password" event.
 *
 * @since 3.0.0
 */
class Changed_Password_Event extends Universal_Analytics_Event {


	/** @var string the event ID */
	public const ID = 'changed_password';
	...
	public function get_form_field_title(): string {
		...
		return __( 'Changed Password', 'woocommerce-google-analytics-pro' );
	}
