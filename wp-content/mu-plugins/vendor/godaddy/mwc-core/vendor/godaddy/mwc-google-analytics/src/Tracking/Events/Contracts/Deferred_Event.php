...
/**
 * Deferrable event interface.
 *
 * Indicates that an event has a deferred frontend trigger.
 *
 * @since 3.0.0
 */
interface Deferred_Event extends Tracking_Event {


	/**
	 * Gets the JS that triggers this event.
	 *
	 * @since 3.0.0
	 *
	 * @return string
