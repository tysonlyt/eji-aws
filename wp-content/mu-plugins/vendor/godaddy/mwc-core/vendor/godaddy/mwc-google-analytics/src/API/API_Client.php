...
use GoDaddy\WordPress\MWC\GoogleAnalytics\API\Universal_Analytics\Management_API;
use GoDaddy\WordPress\MWC\GoogleAnalytics\API\Universal_Analytics\Measurement_Protocol_API as Measurement_Protocol_UA_API;
