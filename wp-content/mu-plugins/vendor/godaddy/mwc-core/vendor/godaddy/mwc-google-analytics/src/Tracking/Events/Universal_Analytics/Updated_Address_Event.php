...
/**
 * The "updated address" event.
 *
 * @since 3.0.0
 */
class Updated_Address_Event extends Universal_Analytics_Event {


	/** @var string the event ID */
	public const ID = 'updated_address';

	/** @var string the event trigger action hook  */
	protected string $trigger_hook = 'woocommerce_customer_save_address';
	...
	public function get_form_field_title(): string {
		...
		return __( 'Updated Address', 'woocommerce-google-analytics-pro' );
	}
	...
	public function get_form_field_description(): string {
		...
		return __( 'Triggered when a customer updates their address.', 'woocommerce-google-analytics-pro' );
	}
