...
/**
 * The "cancelled subscription" event.
 *
 * @since 3.0.0
 */
class Cancelled_Subscription extends Universal_Analytics_Event implements Subscription_Event {

	use Tracks_Subscription_Events;


	/** @var string the event ID */
	public const ID = 'cancelled_subscription';
	...
	public function get_form_field_title(): string {
		...
		return __( 'Cancelled Subscription', 'woocommerce-google-analytics-pro' );
	}
