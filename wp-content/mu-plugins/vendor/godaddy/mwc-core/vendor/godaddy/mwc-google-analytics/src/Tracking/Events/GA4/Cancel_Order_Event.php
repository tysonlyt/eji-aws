...
/**
 * The "cancel order" event
 *
 * @since 3.0.0
 */
class Cancel_Order_Event extends GA4_Event {


	/** @var string the event ID */
	public const ID = 'cancel_order';

	/** @var string the event trigger action hook  */
	protected string $trigger_hook = 'woocommerce_cancelled_order';
	...
	public function get_form_field_title(): string {
		...
		return __( 'Cancel Order', 'woocommerce-google-analytics-pro' );
	}
	...
	public function get_form_field_description(): string {
		...
		return __( 'Triggered when a customer cancels an order.', 'woocommerce-google-analytics-pro' );
	}
	 ...
	 * @inheritdoc
	 *
	 * @param int $order_id ID of the order that was cancelled
	 */
