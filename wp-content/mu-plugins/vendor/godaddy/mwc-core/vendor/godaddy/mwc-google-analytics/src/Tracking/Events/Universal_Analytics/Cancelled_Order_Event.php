...
/**
 * The "cancelled order" event.
 *
 * @since 3.0.0
 */
class Cancelled_Order_Event extends Universal_Analytics_Event {


	/** @var string the event ID */
	public const ID = 'cancelled_order';
	...
	public function get_form_field_title(): string {
		...
		return  __( 'Cancelled Order', 'woocommerce-google-analytics-pro' );
	}
