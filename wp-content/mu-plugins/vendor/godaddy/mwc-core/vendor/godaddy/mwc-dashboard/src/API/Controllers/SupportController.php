...
class SupportController extends AbstractController
{
    ...
    public function createItem(WP_REST_Request $request)
    {
        ...
        $pluginSlug = ! empty(ArrayHelper::get($parameters, 'plugin')) ? SanitizationHelper::input(ArrayHelper::get($parameters, 'plugin')) : '';
        ...
        try {
            $supportRequest = (new SupportRequest)
                ->setFrom(SanitizationHelper::input(ArrayHelper::get($parameters, 'replyTo', '')))
                ->setMessage(StringHelper::unslash(SanitizationHelper::input(ArrayHelper::get($parameters, 'message', ''), true)))
                ->setReason(SanitizationHelper::input(ArrayHelper::get($parameters, 'reason', '')))
                ->setSubject(SanitizationHelper::input(ArrayHelper::get($parameters, 'subject', '')))
