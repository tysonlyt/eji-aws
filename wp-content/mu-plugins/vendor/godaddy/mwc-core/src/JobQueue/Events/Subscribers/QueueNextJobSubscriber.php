...
class QueueNextJobSubscriber implements SubscriberContract
{
    ...
    public function handle(EventContract $event)
    {
        ...
        $this->dispatchNextJob($nextJobClass, $event->chained, $event->args);
    }
     ...
     */
    protected function dispatchNextJob(string $nextJobClass, array $chain, array $args = null) : void
    {
        $this->dispatchService->dispatch($nextJobClass, $chain, $args);
    }
}
