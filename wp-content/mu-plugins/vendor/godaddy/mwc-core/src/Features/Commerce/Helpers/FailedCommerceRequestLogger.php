...
class FailedCommerceRequestLogger
{
     ...
     * @return void
     */
    public static function logFailedRequestFromException(Exception $exception, string $errorMessage = 'Failed Commerce request.', string $logFileName = 'gdCommerceRequestFailures') : void
    {
